...
int main() {
    ...
    if (cat_fat_percentage >= 0 && cat_fat_percentage <= 15) {
        cout << "Skelton" << endl;
    } else if (cat_fat_percentage <= 25) {
        cout << "Fine boi" << endl;
    } else if (cat_fat_percentage <= 35) {
        cout << "Chonk" << endl;
    } else if (cat_fat_percentage <= 45) {
        cout << "Hecking Chonk" << endl;
    } else if (cat_fat_percentage <= 55) {
        cout << "Hefty Chonk" << endl;
    } else if (cat_fat_percentage <= 65) {
        cout << "Mega Chonk" << endl;
    } else if (cat_fat_percentage <= 100) {
